Rails.application.routes.draw do
  ...
  get '/renters-policies-tpoaro', to: 'renters_rights#renters_policies_TPOARO'
  get '/renters-policies-eaotpoaro', to: 'renters_rights#renters_policies_EAOTPOARO'
  get '/renters-policies-tpo', to: 'renters_rights#renters_policies_TPO'
  get '/renters-policies-mho', to: 'renters_rights#renters_policies_MHO'
  get '/renters-policies-general', to: 'renters_rights#renters_policies_general'
  get '/renters-policies-general-scc', to: 'renters_rights#renters_policies_general_SCC'
