...
export default class LegalAid extends React.Component {
  render() {
      ...
      <RentersLayout>
        <div className="content-container">
          ...
          <div className="col-md-3">
            ...
            <p>Check out <a href="https://www.1degree.org" target="_blank">One Degree</a>, to find resources in the San Francisco Bay Area</p>
          </div>
        </div>
       </div>
     </RentersLayout>
