          ...
          <div className="panel-group" id="accordion">
            <div className="panel panel-default">
              ...
              <div id="collapse6" className="panel-collapse collapse">
                <div className="panel-body">
                  <strong>The San Jose City Council has made changes to the Tenant Protection Ordinance that may impact your rental properties. These changes are in effect as of January 18, 2019.</strong>
                  <br/>
                  <p>
                  Apartment owners are required to post a <a href="http://www.sanjoseca.gov/DocumentCenter/View/82303" target="_blank">a notice of tenant rights</a> in a conspicuous place in each building, 
                  or provide every tenant with a copy of this notice. The notice will be available to you by January 18, and we will send a follow up email with the link to the document.
                  </p>
                  <p>
                  Any tenant who is charged with a crime has a right to return to his or her rental unit under the following conditions:
                  </p>
                  <ul>
                    <li>
                  ...
                  <p>
                  The City of San José recognizes state and federal protections for tenants who are victims of violence. 
                  You can find more information about state protections <a href="http://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?lawCode=CCP&sectionNum=1161.3" target="_blank">here</a> 
                  and federal protections <a href="https://www.congress.gov/113/plaws/publ4/PLAW-113publ4.pdf" target="_blank">here</a>. 
                  </p>
                  <p>
                    Whenever you terminate a tenancy, you must include a statement that states the notice is being served in good faith and provides information about homelessness prevention. 
                    The language for this statement is available <a href="http://www.sanjoseca.gov/DocumentCenter/View/82304" target="_blank">here</a>.
                  </p>
                  <hr/>
                  <br/>
            ...
            <div className="panel panel-default">
              ...
              <div id="collapse8" className="panel-collapse collapse">
                <div className="panel-body">
                <br/>
                <p><h3> Under TPO, landlords must include one of the following 13 reasons for termination in any 30-60-90 notice to vacate to the tenant:</h3></p>
                <li className="list-group-item active"><h2>Just Cause Terminations </h2> <p>The reasons for no-cause notice to vacate that signify fault on the part of the tenant are:</p></li>
                ...
                <li className="list-group-item active"><h2>Just Cause Reasons Based on Landlord Decision or Consequence of Action </h2><p>Relocation benefits must be paid when a Tenant is being removed from an apartment for reasons #8-13.</p></li>
