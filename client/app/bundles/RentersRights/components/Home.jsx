       ...
       <RentersLayout>
         <div className="content-container">
           <div className="page-header text-center">
             ...
             <p>From 2017-2019, we built and maintained the website, keeping it up to date with the latest policy changes from the City of San José. </p>
             <p>In early January 2020, we decided to archive the original website, because the City of San José Housing Department has improved their website user interface</p>
             <p>We are now collaborating with Stanford Legal Design Lab students to build tools that help tenants facing eviction.</p>
